...
## loading the required packages for the workflow
library(ExpressionNormalizationWorkflow)
```

```{r eval=TRUE, echo=FALSE}
exprs <- system.file("extdata",  "CAD_Expression.csv",   package="ExpressionNormalizationWorkflow")  
## reading the file containing the gene expression values
covrt s<- system.file("extdata",  "CAD_ExptDsgn.csv",   package="ExpressionNormalizationWorkflow")  
